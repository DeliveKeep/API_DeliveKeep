...
// Atualiza telefone na tabela administradores
func AtualizarTelefoneAdministrador(dados models.Administrador, db *sql.DB) error {
	sqlStatement := `UPDATE administradores SET telefone=$1 WHERE id_administrador=$2`
